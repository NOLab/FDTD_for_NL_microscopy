...
// Inputs GUI
  ...
  Dialog.create("Test");
  Dialog.addString("Directory:", ".\_data");
  //Dialog.addChoice("Options:", newArray("STD", "QuickPALM", "DoM", "mean"));
 // Dialog.addCheckbox("Save P-THG Stack", true);
...
Dialog.addNumber("Polarization offset", 80);
Dialog.addNumber("Polarization spacing (deg)",10);
  Dialog.addMessage("Post-processing") ;
  Dialog.addNumber("R-squared Threshold (AU)",300);
